...
### VARIABLES
doc_name = 'main.tex' # name of main tex document that integrates the sections and specifies the topics
sections = ['section1.tex'] # ['section1.tex', 'section2.tex',...] # names of sections in ./section/ folder
